...
const stats = [
  ...
  { value: '₹65Cr+', label: 'Funding Enabled' },
  { value: '180+', label: 'Mentors & Advisors' },
]
...
const partnerLogos = ['SINE IIT Bombay', 'TiE Nagpur', 'STPI', 'BioNEST']
    ...
    <section id="home" className="relative mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-8 lg:px-10 lg:pb-20 lg:pt-20">
      <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div data-reveal-id="hero-copy" className="transition duration-700 data-[visible=false]:translate-y-5" data-visible="true">
          ...
          <h1 className="mt-4 max-w-2xl bg-gradient-to-r from-cyan-300 via-blue-300 to-blue-700 bg-[length:220%_220%] bg-clip-text text-6xl font-bold leading-[0.98] tracking-tight text-transparent animate-pulse sm:text-7xl lg:text-8xl">
            Incubation Center
          </h1>
          <p className="mt-4 max-w-2xl text-2xl font-semibold leading-tight text-white/95 sm:text-3xl lg:text-4xl">
            Empowering Startups & Innovation
          </p>
